...
public final class GetBikeLostRequest {
  ...
  public  static final class GetBikeLostRequestMessage extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return GetBikeLostRequest.internal_static_GetBikeLostRequestMessage_descriptor;
    }

    protected FieldAccessorTable
        internalGetFieldAccessorTable() {
      return GetBikeLostRequest.internal_static_GetBikeLostRequestMessage_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              GetBikeLostRequestMessage.class, Builder.class);
    }
    ...
    public boolean equals(final Object obj) {
      ...
      if (!(obj instanceof GetBikeLostRequestMessage)) {
        return super.equals(obj);
      }
      GetBikeLostRequestMessage other = (GetBikeLostRequestMessage) obj;
    ...
    public static GetBikeLostRequestMessage parseFrom(
    ...
    public static GetBikeLostRequestMessage parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static GetBikeLostRequestMessage parseFrom(
    ...
    public static GetBikeLostRequestMessage parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static GetBikeLostRequestMessage parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static GetBikeLostRequestMessage parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(GetBikeLostRequestMessage prototype) {
    ...
    public static final class Builder extends
      ...
      // Construct using com.yzh.rfidbike.app.request.GetBikeLostRequest.GetBikeLostRequestMessage.newBuilder()
      private Builder() {
      ...
      public GetBikeLostRequestMessage getDefaultInstanceForType() {
        return GetBikeLostRequestMessage.getDefaultInstance();
      }

      public GetBikeLostRequestMessage build() {
        GetBikeLostRequestMessage result = buildPartial();
      ...
      public GetBikeLostRequestMessage buildPartial() {
        GetBikeLostRequestMessage result = new GetBikeLostRequestMessage(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof GetBikeLostRequestMessage) {
          return mergeFrom((GetBikeLostRequestMessage)other);
        } else {
      ...
      public Builder mergeFrom(GetBikeLostRequestMessage other) {
        if (other == GetBikeLostRequestMessage.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        GetBikeLostRequestMessage parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (GetBikeLostRequestMessage) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final GetBikeLostRequestMessage DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new GetBikeLostRequestMessage();
    }

    public static GetBikeLostRequestMessage getDefaultInstance() {
  ...
  static {
    String[] descriptorData = {
      "\n\030GetBikeLostRequest.proto\"H\n\031GetBikeLos" +
      "tRequestMessage\022\017\n\007session\030\001 \001(\t\022\n\n\002id\030\002" +
      " \001(\003\022\016\n\006bikeId\030\003 \001(\003B2\n\034com.yzh.rfidbike" +
      ".app.requestB\022GetBikeLostRequestb\006proto3"
    };
