...
import com.foxconn.rfid.theowner.view.material.Slider;
import com.foxconn.rfid.theowner.view.material.Slider.OnValueChangedListener;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		backView.setOnTouchListener(new OnTouchListener() {
			...
			public boolean onTouch(View v, MotionEvent event) {
				if (event.getX() < view.getLeft() || event.getX() > view.getRight() || event.getY() > view.getBottom()
