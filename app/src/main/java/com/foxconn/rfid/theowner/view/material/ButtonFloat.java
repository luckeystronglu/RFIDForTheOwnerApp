package com.foxconn.rfid.theowner.view.material;
...
import com.foxconn.rfid.theowner.animation.ObjectAnimator;
import com.foxconn.rfid.theowner.util.Utils;
import com.foxconn.rfid.theowner.view.animation.ViewHelper;
...
public class ButtonFloat extends Button {
	...
	public ButtonFloat(Context context, AttributeSet attrs) {
		...
		LayoutParams params = new LayoutParams(Utils.dpToPx(sizeIcon, getResources()), Utils.dpToPx(sizeIcon,
				getResources()));
	...
	protected void onDraw(Canvas canvas) {
		...
		if (x != -1) {
			...
			Rect dst = new Rect(Utils.dpToPx(1, getResources()), Utils.dpToPx(2, getResources()), getWidth()
					- Utils.dpToPx(1, getResources()), getHeight() - Utils.dpToPx(2, getResources()));
