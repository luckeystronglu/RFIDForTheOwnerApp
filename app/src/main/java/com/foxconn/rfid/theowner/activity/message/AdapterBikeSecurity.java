...
import com.yzh.rfidbike.app.response.SecurityMessage;
...
public class AdapterBikeSecurity extends BaseAdapter{
    ...
    public AdapterBikeSecurity(Context context) {
        super();
...
//        this.cacheMap = new HashMap<Integer, String>();
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView!=null){
            ...
            convertView  = LayoutInflater.from(context).inflate(R.layout.item_sysmessage_lv, null);
